...
public class Person {
    ...
    public Person(int personId,String code, String dni, String name, String lastName, int age, String mail,String personStatus) {
    ...
    public Person setPersonId (int personId){ this.personId = personId; return this; }

    public String getCode() {
        return code;
    }

    public Person setCode(String code) { this.code = code; return this; }

    public String getDni() {
        return dni;
    }

    public Person setDni(String dni) { this.dni = dni; return this; }
    ...
    public Person setMail(String mail) { this.mail = mail; return this; }
